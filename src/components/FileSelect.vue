...
<template>
  <div class="relative flex flex-col gap-y-6 mt-6 px-8 my-8">
    ...
    <label id="drop-area" for="file_picker"
      class="cursor-pointer select-none w-full md:w-[60rem] mx-auto bg-gray-100 text-white text-center py-5 px-10 rounded-md focus:outline-none inline-block flex-shrink-0 overflow-hidden">
      <div class="flex flex-col items-center justify-center pt-5 pb-6 md:pt-5 md:pb-6 lg:pt-5 lg:pb-6 xl:pt-5 xl:pb-6 2xl:pt-5 2xl:pb-6
        ...
        <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400 md:w-8 md:h-8 lg:w-8 lg:h-8 xl:w-8 xl:h-8 2xl:w-8 2xl:h-8
          xs:w-6 xs:h-6 sm:w-6 sm:h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
          viewBox="0 0 20 16">
